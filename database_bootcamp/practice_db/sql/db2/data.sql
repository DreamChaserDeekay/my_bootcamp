...
INSERT INTO orders (customer_id, total_amount, status, created_at) VALUES
    (1, 2390000, 'PAID',      TIMESTAMP('2026-05-01-10.00.00')),
    (1,  360000, 'PAID',      TIMESTAMP('2026-05-03-14.30.00')),
    (2, 1550000, 'PAID',      TIMESTAMP('2026-05-02-09.15.00')),
    (3,  890000, 'PENDING',   TIMESTAMP('2026-05-05-11.00.00')),
    (4, 1390000, 'PAID',      TIMESTAMP('2026-05-04-16.20.00')),
    (5,  450000, 'CANCELLED', TIMESTAMP('2026-05-06-13.45.00')),
    (1,  120000, 'PAID',      TIMESTAMP('2026-05-08-08.30.00')),
    (6, 1890000, 'PAID',      TIMESTAMP('2026-05-09-17.00.00')),
    (7,   50000, 'PAID',      TIMESTAMP('2026-05-10-12.00.00')),
    (8,  990000, 'FAILED',    TIMESTAMP('2026-05-11-19.30.00'));
